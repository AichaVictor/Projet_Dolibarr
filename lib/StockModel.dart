...
List<Commandes> commandeFromJson(String str) => List<Commandes>.from(json.decode(str).map((x) => Commandes.fromJson(x)));

String commandeToJson(List<Commandes> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Commandes {
  Commandes({
    ...
    required this.modeReglementCode,
    this.availabilityId,
